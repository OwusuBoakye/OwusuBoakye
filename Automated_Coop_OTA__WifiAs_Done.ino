...
//Light and heating
 ...
 void handle_OnConnect()
 {
   ...
   server.send(200, "text/html", SendHTML(t, h, H, M, S, Y, Mo, D, Da, lightstatus, heatstatus, DoorOpen, DoorClose, WindowClose, WindowOpen));
 }
 ...
 void handle_lighton()
 {
  ...
  // Web design
   String SendHTML(float t, float h,int H, int M,int S,int Y,String Mo,int D, String Da, int lightstat, int heatstat, bool Dopen, bool Dclose, bool WindowO, bool WindowC)
 {
